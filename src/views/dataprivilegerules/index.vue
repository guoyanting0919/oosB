    ...
    <div class="app-container flex-item">
      ...
      >
        ...
        >
            ...
            <el-col :span="12">
              ...
              >
                ...
                <el-select
                  ...
                  size="mini"
                  v-model="temp.sourceCode"
                  @change="handleSourceCode"
                >
                  <el-option
          ...
          <add-rule
            v-if="temp.sourceCode"
            :dataSource="temp.privilegeRules"
          ...
          <el-row>
            ...
            <el-col :span="14">
              <el-form-item size="small" :label="'權限描述'" prop="description">
      ...
      <!-- <el-dialog v-el-drag-dialog :destroy-on-close="true" class="dialog-mini" width="800px" title="權限規則"
        ...
        <div style="text-align:right;margin-top: 10px;">
          ...
          <el-button size="small" type="primary" @click="handleSaveRules">確定</el-button>
        </div>
      </el-dialog>-->
    </div>
  </div>
...
export default {
  ...
  data() {
    return {
      // requestRules: {},
      propertyDatas: [],
      multipleSelection: [], // 列表c eckbox選中的值
      tableKey: 0,
      list: null,
      total: 0,
      listLoading: true,
      ...
      temp: {
        id: "", // 數據ID
        sourceCode: "", // 資源標識（模塊編號）
        subSourceCode: "", // 二級資源標識
        description: "", // 權限描述
        sortNo: "", // 排序號
        privilegeRules: "", // 權限規則
        enable: true, // 是否可用
    ...
    createData() {
      ...
      this.temp.privilegeRules =
        (this.temp.sourceCode &&
          JSON.stringify(this.$refs.addRule.saveRule())) ||
        "";
